...
namespace PumpkinSoup.AOC2025.UnitTests.App.Puzzles.Handlers.Given_A_CalculateMaximumJoltageInBankCollection;
...
public class When_Solve_Is_Called
{
    ...
    {
        // Arrange
        var command = new CalculateMaximumJoltageInBankCollection();
